...
function iniciarNovoJogo() {
    ...
    if (!primeiraInicializacaoConcluida) {
        if (filaGeral.length === 0 && filaEstrela.length === 0) {
            filaGeral = ["Anderson", "Danilo", "Edinho", "Iba", "Julio Cesar", "Kauan", "Lucas", "Marciano", "Mateus Henrique", "Matheus Lael", "Matheus Matos", "Odair", "Pedro", "Rafael", "Thalyson", "Wendel"];
            filaEstrela = ["Daniele", "Gabi", "Guilherme Basso", "Karen", "Paty", "Sara"];
